 ...
 */
public class StatementWrapper<S extends Statement> implements Statement {
     ...
     */
    public StatementWrapper(ISQLInjectionAnalyzer analyzer, S realStatement) {
        super();
    ...
    protected final S getRealStatement() {
    ...
    public Connection getConnection() throws SQLException {
        Connection connection = new ConnectionWrapper(analyzer, realStatement.getConnection());
        return connection;
    }
